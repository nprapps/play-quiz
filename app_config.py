...
PROJECT_SLUG = 'play-quiz'

# Project name to be used in file paths
PROJECT_FILENAME = 'play_quiz'

# The name of the repository containing the source
REPOSITORY_NAME = 'play-quiz'
REPOSITORY_URL = 'git@github.com:nprapps/%s.git' % REPOSITORY_NAME
REPOSITORY_ALT_URL = None # 'git@bitbucket.org:nprapps/%s.git' % REPOSITORY_NAME'

# Project name used for assets rig
# Should stay the same, even if PROJECT_SLUG changes
ASSETS_SLUG = 'play-quiz'
...
COPY EDITING
"""
COPY_GOOGLE_DOC_URL = 'https://docs.google.com/spreadsheet/ccc?key=0Alg9G6ua2W2fdGJ5cHF1YlIwOVRsb2RsOUcwd210dmc&usp=drive_web#gid=1'
...
DISQUS_UUID = 'd77b93c7-10ff-11e4-896a-a820662c8a94'
