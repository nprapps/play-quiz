...
```
cd play-quiz
mkvirtualenv --no-site-packages play-quiz
...
```
* * * * * ubuntu bash /home/ubuntu/apps/play_quiz/repository/cron.sh fab $DEPLOYMENT_TARGET cron_jobs.test 
```
...
|--------|------|-----|-----|--------|--------|
|play-quiz|tweet|`location`||||
|play-quiz|facebook|`location`||||
|play-quiz|email|`location`||||
|play-quiz|new-comment||||
|play-quiz|open-share-discuss||||
|play-quiz|close-share-discuss||||
|play-quiz|summary-copied||||
|play-quiz|featured-tweet-action|`action`||``tweet_url``|
|play-quiz|featured-facebook-action|`action`||``post_url``|
